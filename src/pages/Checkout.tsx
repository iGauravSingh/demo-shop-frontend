...
const Checkout = () => {
  ...
  const handlePayment = async () => {
    alert("This is a demo App , This will create user order visit profile to see order")
          ...
          <div className="flex flex-col space-y-4 mt-4">
            {shop.map((product) => (
              <div key={product.id} className="flex justify-between items-center bg-gray-50 p-4 rounded-lg shadow-sm">
                <img src={product.productImage} alt={product.productName} className="w-16 h-16 rounded-md" />
